...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory{
        public AtomicInteger threadCount = new AtomicInteger(1);
        public AtomicInteger factoryCount = new AtomicInteger(ai.incrementAndGet());
        @Override
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(GN + "-pool-" + factoryCount + "-thread-" + threadCount);
