    ...
    public static class Gamer extends Thread {
        ...
        public void run()
        {
            ...
            while (!OnlineGame.isWinnerFound) {
                try {
                    System.out.println(getName() + ":" + OnlineGame.steps.get(cycles));
                    Thread.sleep(1000 / rating);
                    cycles++;
                    if (cycles == OnlineGame.steps.size()) {
            ...
            if(cycles < OnlineGame.steps.size())  System.out.println(getName() + ":проиграл");
        }
